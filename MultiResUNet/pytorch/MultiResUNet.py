...
def trainStep(model, X_train=None, Y_train=None, X_val=None, Y_val=None,
              ...
              train_patch_size=0, patch_sampling_probability=1.0,
              patch_resize_to_full=False, patch_positive_probability=0.75,
    ...
    hparams = {
        ...
        'init_checkpoint': init_checkpoint if init_checkpoint is not None else '',
        'train_augmentation': train_augmentation,
        'val_augmentation': val_augmentation,
        'repeat_factor': repeat_factor,
        'train_patch_size': train_patch_size,
        'patch_sampling_probability': patch_sampling_probability,
        'patch_resize_to_full': bool(patch_resize_to_full),
